...
class drqn_agent_efficient():
    ...
    def build_main(self):
        ...
        for i in range(self.N_station):
            ...
            hyst_error=tf.where(self.targetQ[i]-Q<0,0.5*huber_error,huber_error,name=myScope+'_hysterError')
